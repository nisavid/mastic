...
it does not define the mastic configuration schema or select a thinking mode
...
If mastic retains operation-specific profile names, each name should resolve to
...
## Implemented mastic binding

mastic keeps all three upstream profiles as exact-revision knowledge. Guided
