...
# Bump whenever a persisted Runtime Installation observation requires a fresh probe.
LEGACY_RUNTIME_OBSERVATION_PROBE_VERSION = 1
RUNTIME_OBSERVATION_PROBE_VERSION = 3
